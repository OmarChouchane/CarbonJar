...
const Header = () => (
  ...
  >
    <header>
      <div className="mx-auto mb-4 max-w-4xl py-12 sm:mt-4 sm:mb-8 sm:px-4 md:mt-4 md:mb-6 lg:mt-10 lg:mb-10 lg:px-6">
        <br />
        <H1 className="leading-tight">Measuring Today, Preserving Tomorrow.</H1>
        <br />
        <H2>
          Empowering businesses with the tools to measure, manage, and reduce their carbon
          footprints for a greener future.
        </H2>
