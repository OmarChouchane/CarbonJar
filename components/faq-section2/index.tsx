...
const FAQSection: React.FC = () => {
  return (
    ...
    >
      <section className="mb-12 px-2 sm:mx-1 md:mx-10 lg:mx-32 lg:mt-8 lg:px-8">
        <SmallerH1 className="text-white-light">FAQs</SmallerH1>
        <H2 className="text-white-light">Replying to the most frequently asked questions</H2>
        <br />
