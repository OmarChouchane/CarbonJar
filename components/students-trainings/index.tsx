...
const StudentsTrainings: React.FC = () => {
  const Courses: CourseCardType[] = [
    {
      ...
      content1: [
        ...
        ['Goal and scope', 'Inventory analysis', 'Impact assessment', 'Interpretation of results'],
  ...
  return (
    ...
    >
      <section className="bg-green mt-6 flex flex-col p-6 lg:mt-40 lg:p-12 lg:pt-20 lg:pb-20">
        <SmallerH1 className="text-white-light">Featured Students Training Courses</SmallerH1>
        <br />
        <H2 className="text-white-light">
          Enhance your team’s expertise, drive operational efficiency, and achieve your
          sustainability goals with our specialized training programs.
        </H2>
        ...
        <br />
        <SmallerH1 className="text-white-light">Ready to make a difference ?</SmallerH1>
        <br />
        <H2 className="text-white-light">
          Join us now and start your journey towards sustainability!
        </H2>

        <div className="mx-auto mt-8 mb-8 flex w-full items-center justify-center">
