...
const CarbonCards: React.FC = () => {
  ...
  return (
    ...
    >
      <section className="bg-green rounded-lg p-8 lg:mx-44 lg:mt-8">
        <div className="container mx-auto">
          <SmallerH1 className="text-white-light lg:text-5xl">Our field of expertise</SmallerH1>
          <br />
          <H2 className="text-white-light">
            We offer a comprehensive suite of services designed to help your organization navigate{' '}
            <br />
