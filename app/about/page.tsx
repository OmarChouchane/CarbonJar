...
export default function AboutPage() {
  ...
  return (
    <>
      <ScrollProgress />
      <main className="bg-white-light min-h-screen px-2 lg:px-8 lg:mx-32">
            ...
            <BigCard3
              ...
              description={
                <>
                  ...
                  than <span className="text-light-green">1.5°C</span>. Since
                  the industrial revolution, businesses have been responsible
                  for the vast majority of emissions. Now, businesses can lead
                  the way to a sustainable future. In line with the Paris
                  Agreement, we must take{" "}
            ...
            <BigCard1
              ...
              description={
                <>
                  ...
                  insights to reduce emissions. <br />
                  <strong>
